...
class FavoriteAdapter(
...
) : RecyclerView.Adapter<FavoriteAdapter.Holder>(), View.OnClickListener {

    private var searchItems: List<FavoriteItemUiState> = emptyList()

    override fun onClick(v: View) {
        val character = v.tag as FavoriteItemUiState
    ...
    fun renderSettings(items: List<FavoriteItemUiState>) {
        searchItems = items
